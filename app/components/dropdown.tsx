  ...
  return (
    <HeadlessMenuItem
      ...
      className={clsx(
        ...
        // Text styles
        "text-zinc-950 text-left text-base/6 sm:text-sm/6 dark:text-white forced-colors:text-[CanvasText]",
        ...
        "[&>[data-slot=icon]]:text-zinc-500 [&>[data-slot=icon]]:dark:text-zinc-500 [&>[data-slot=icon]]:data-[focus]:text-white [&>[data-slot=icon]]:data-[focus]:dark:text-white",
      )}
    />
  );
}
...
export function DropdownHeading({
  ...
  return (
    <HeadlessMenuHeading
      ...
      className={clsx(
        className,
        "text-zinc-500 dark:text-zinc-400 col-span-full grid grid-cols-[1fr,auto] gap-x-12 px-3.5 pb-1 pt-2 text-sm/5 font-medium sm:px-3 sm:text-xs/5",
      )}
    />
  );
}
...
export function DropdownSeparator({
  ...
  return (
    <HeadlessMenuSeparator
      ...
      className={clsx(
        className,
        "bg-zinc-950/5 col-span-full mx-3.5 my-1 h-px border-0 sm:mx-3 dark:bg-white/10 forced-colors:bg-[CanvasText]",
      )}
    />
  );
}
...
export function DropdownDescription({
  ...
  return (
    <HeadlessDescription
      ...
      className={clsx(
        className,
        "text-zinc-500 dark:text-zinc-400 col-span-2 col-start-2 row-start-2 text-sm/5 group-data-[focus]:text-white sm:text-xs/5 forced-colors:group-data-[focus]:text-[HighlightText]",
      )}
    />
  );
}
