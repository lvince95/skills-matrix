    ...
    <HeadlessListbox {...props} multiple={false}>
      <HeadlessListboxButton
        ...
        className={clsx([
          ...
          // Focus ring
          "sm:after:data-[focus]:ring-blue-500 after:pointer-events-none after:absolute after:inset-0 after:rounded-lg after:ring-inset after:ring-transparent sm:after:data-[focus]:ring-2",
      ...
      >
        <HeadlessListboxSelectedOption
          ...
          className={clsx([
            ...
            // Typography
            "text-zinc-950 placeholder:text-zinc-500 text-left text-base/6 sm:text-sm/6 dark:text-white forced-colors:text-[CanvasText]",

            // Border
            "border-zinc-950/10 group-data-[active]:border-zinc-950/20 group-data-[hover]:border-zinc-950/20 border dark:border-white/10 dark:group-data-[active]:border-white/20 dark:group-data-[hover]:border-white/20",
        ...
        <span className="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-2">
          <svg
            className="stroke-zinc-500 group-data-[disabled]:stroke-zinc-600 dark:stroke-zinc-400 size-5 sm:size-4 forced-colors:stroke-[CanvasText]"
            viewBox="0 0 16 16"
            aria-hidden="true"
            fill="none"
          >
      ...
      >
        <HeadlessListboxOptions
          ...
          className={clsx(
            ...
            // Shadows
            "ring-zinc-950/10 shadow-lg ring-1 dark:ring-inset dark:ring-white/10",
          )}
        >
          {options}
        </HeadlessListboxOptions>
        ...
        return (
          <div
            className={clsx(
              ...
              // Typography
              "text-zinc-950 text-base/6 sm:text-sm/6 dark:text-white forced-colors:text-[CanvasText]",

              // Focus
              "data-[focus]:bg-blue-500 outline-none data-[focus]:text-white",
...
export function ListboxDescription({
  ...
  return (
    <span
      className={clsx(
        className,
        "text-zinc-500 dark:text-zinc-400 flex flex-1 overflow-hidden before:w-2 before:min-w-0 before:shrink group-data-[focus]/option:text-white",
      )}
      {...props}
    >
