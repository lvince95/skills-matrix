...
export function Legend({ ...props }: HeadlessLegendProps) {
  return (
    <HeadlessLegend
      ...
      className={clsx(
        props.className,
        "text-zinc-950 text-base/6 font-semibold data-[disabled]:opacity-50 sm:text-sm/6 dark:text-white",
      )}
    />
  );
}
...
export function Label({
  ...
  return (
    <HeadlessLabel
      ...
      className={clsx(
        className,
        "text-zinc-950 select-none text-base/6 data-[disabled]:opacity-50 sm:text-sm/6 dark:text-white",
      )}
    />
  );
}
...
export function Description({
  ...
  return (
    <HeadlessDescription
      ...
      className={clsx(
        className,
        "text-zinc-500 dark:text-zinc-400 text-base/6 data-[disabled]:opacity-50 sm:text-sm/6",
      )}
    />
  );
}
...
export function ErrorMessage({
  ...
  return (
    <HeadlessDescription
      ...
      className={clsx(
        className,
        "text-red-600 dark:text-red-500 text-base/6 data-[disabled]:opacity-50 sm:text-sm/6",
      )}
    />
  );
}
